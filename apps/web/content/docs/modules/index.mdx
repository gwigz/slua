...
`@gwigz/slua-modules` is a set of reusable runtime modules for
...
through [TypeScript-to-Lua](https://typescripttolua.github.io), and `@define`
flags strip whatever you did not enable.
