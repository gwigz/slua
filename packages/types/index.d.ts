...
declare class Vector {
    ...
    mul: LuaMultiplicationMethod<number, vector> & LuaMultiplicationMethod<vector, vector> & LuaMultiplicationMethod<quaternion, vector>;
    /** Division: vector / number -> vector (Scale), vector / quaternion -> vector (Rotation by inverse) */
    div: LuaDivisionMethod<number, vector> & LuaDivisionMethod<vector, vector> & LuaDivisionMethod<quaternion, vector>;
...
declare namespace string {
    ...
    export function find(s: string, pattern: string, init?: number, plain?: boolean): LuaMultiReturn<[number | undefined, number | undefined, ...args: string[]]>;
...
declare namespace ll {
    ...
    export function GiveAgentInventory(AgentID: uuid, FolderName: string, InventoryItems: string[], Options: list): number;
     ...
     */
    export function GiveInventoryList(TargetID: uuid, FolderName: string, InventoryItems: string[]): void;
     ...
     */
    export function LinkPlaySound(LinkNumber: number, Sound: string, Volume: number, Flags: number): void;
     ...
     */
    export function Listen(Channel: number, SpeakersName: string, SpeakersID: uuid, Text: string): number;
     ...
     */
    export function MakeExplosion(Particles: number, Scale: number, Velocity: number, Lifetime: number, Arc: number, Texture: string, Offset: vector): void;
     ...
     */
    export function MakeFire(Particles: number, Scale: number, Velocity: number, Lifetime: number, Arc: number, Texture: string, Offset: vector): void;
     ...
     */
    export function MakeFountain(Particles: number, Scale: number, Velocity: number, Lifetime: number, Arc: number, Bounce: number, Texture: string, Offset: vector, Bounce_Offset: number): void;
     ...
     */
    export function MakeSmoke(Particles: number, Scale: number, Velocity: number, Lifetime: number, Arc: number, Texture: string, Offset: vector): void;
     ...
     */
    export function MessageLinked(LinkNumber: number, Number: number, Text: string | uuid, ID: string | uuid): void;
     ...
     */
    export function ParseStringKeepNulls(Text: string, Separators: string[], Spacers: string[]): string[];
     ...
     */
    export function PushObject(ObjectID: uuid, Impulse: vector, AngularImpulse: vector, Local: number): void;
    ...
    /** This function is deprecated. */
    export function RemoteDataReply(ChannelID: uuid, MessageID: uuid, sData: string, iData: number): void;

    /** This function is deprecated. */
    export function RemoteDataSetRegion(): void;

    export function RemoteLoadScript(Target: uuid, ScriptName: string, Unknown1: number, Unknown2: number): void;
    ...
    export function RemoteLoadScriptPin(ObjectID: uuid, ScriptName: string, PIN: number, Running: number, StartParameter: number): void;
    ...
    export function ReplaceAgentEnvironment(agent_id: uuid, transition: number, environment: string): number;

    /** Replaces the environment for a parcel or region. */
    export function ReplaceEnvironment(position: vector, environment: string, track_no: number, day_length: number, day_offset: number): number;
    ...
    export function ReplaceSubString(InitialString: string, SubString: string, NewSubString: string, Count: number): string;
     ...
     */
    export function RezAtRoot(InventoryItem: string, Position: vector, Velocity: vector, Rotation: quaternion, StartParameter: number): void;
     ...
     */
    export function RezObject(InventoryItem: string, Position: vector, Velocity: vector, Rotation: quaternion, StartParameter: number): void;
    ...
    /** This function is deprecated. */
    export function SendRemoteData(ChannelID: uuid, Destination: string, Value: number, Text: string): uuid;
     ...
     * Results are returned in the sensor and no_sensor events.
     */
    export function SensorRepeat(Name: string, ID: uuid, Type: number, Range: number, Arc: number, Rate: number): void;
    ...
    export function SetInventoryPermMask(InventoryItem: string, PermissionFlag: number, PermissionMask: number): void;
    ...
    export function SetLinkRenderMaterial(LinkNumber: number, RenderMaterial: string, Face: number): void;
     ...
     */
    export function SetLinkTextureAnim(LinkNumber: number, Mode: number, Face: number, SizeX: number, SizeY: number, Start: number, Length: number, Rate: number): void;
     ...
     */
    export function SetPhysicsMaterial(MaterialBits: number, GravityMultiplier: number, Restitution: number, Friction: number, Density: number): void;
     ...
     * Rate specifies the animation playback rate.
     */
    export function SetTextureAnim(Mode: number, Face: number, SizeX: number, SizeY: number, Start: number, Length: number, Rate: number): void;
     ...
     */
    export function TeleportAgent(AvatarID: uuid, LandmarkName: string, Position: vector, LookAtPoint: vector): void;
     ...
     * This function can only teleport the owner of the object.
     */
    export function TeleportAgentGlobalCoords(AvatarID: uuid, GlobalPosition: vector, RegionPosition: vector, LookAtPoint: vector): void;
    ...
    export function UpdateKeyValue(Key: string, Value: string, Checked: number, OriginalValue: string): uuid;
    ...
    export function VerifyRSA(PublicKey: string, Message: string, Signature: string, Algorithm: string): number;
